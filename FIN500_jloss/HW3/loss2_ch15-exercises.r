...
# Get ltcorpbond 
ltcorpbond <- Quandl("FRED/BAA10Y", type="xts")[,1]
colnames(ltcorpbond) <- c("LTCorpBond")
#this is CMG
...
alldata <- na.locf(alldata.full)["2014/2018-01-01"]

# create excess returns for indices, stocks
##similar to chapter 14, but I need to get 14 right first
